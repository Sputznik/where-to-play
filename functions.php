...
add_action('wp_enqueue_scripts',function(){
  ...
  wp_enqueue_style('sp-child-css', get_stylesheet_directory_uri().'/assets/css/where-to-play.css', array('sp-core-style'), WTP_THEME_VERSION );
	...
	if ( is_page_template( 'page-ai-workbook.php' ) ) {
		wp_enqueue_style( 'ai-workbook-css', get_stylesheet_directory_uri() . '/assets/css/ai-workbook.css', array(), WTP_THEME_VERSION );
		wp_enqueue_script( 'ai-workbook-js', get_stylesheet_directory_uri() . '/assets/js/ai-workbook.js', array(), WTP_THEME_VERSION, true );
	}
